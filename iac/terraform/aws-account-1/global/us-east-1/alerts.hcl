locals {
  ...
  lambda_function_arn                = "arn:aws:lambda:us-east-1:567243246807:function:phil-dev-print-cw-alarm-details"
  lambda_function_name               = "phil-dev-print-cw-alarm-details"
}
